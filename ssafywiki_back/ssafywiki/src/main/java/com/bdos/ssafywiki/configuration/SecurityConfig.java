...
import com.bdos.ssafywiki.jwt.JwtAccessDeniedHandler;
import com.bdos.ssafywiki.jwt.JwtAuthenticationEntryPoint;
import com.bdos.ssafywiki.jwt.JwtSecurityConfig;
import com.bdos.ssafywiki.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http
                ...
                .headers((headers)-> headers.frameOptions(option-> option.disable()))// crsf 보안 X (rest api)
                .apply(new MyCustomDsl());


        http.sessionManagement(httpSecuritySessionManagementConfigurer -> httpSecuritySessionManagementConfigurer.sessionCreationPolicy(SessionCreationPolicy.STATELESS)); // jwt token으로 인증 > 세션 필요없음
