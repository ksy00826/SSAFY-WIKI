...
const SignUp = () => {
  ...
  return (
    ...
    >
      ...
      {current === 1 ? (
        <Form2 goNext={next} info={info} saveInfo={save2} saveGithub={saveGithub}></Form2>
      ) : (
        <></>
      )}
      {current === 2 ? (
        <>
          ...
          <Input addonBefore="GITHUB ID" onChange={saveGithub} defaultValue={(info2.email || "").split('@')[0]}></Input>
